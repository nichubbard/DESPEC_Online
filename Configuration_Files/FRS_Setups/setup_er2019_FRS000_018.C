...
void setup_er2019_FRS000_018()
{
  ...
  //**S323,410 exp.
  frs->dist_MUSIC41  = 555.0;  // TUM1
  frs->dist_MUSIC42  = 1210.0; // Travelling MUSIC 
  frs->dist_MUSIC43  = 1210.0; // TUM2
  ...
  */
  ...
  id-> id_tofoff2 =  267690;    // Offset (ps)
  id-> id_path2   =   120500.0;  // Path/c (ps) this number fit
...
// =======
 ...
 id->ID_x2AoverQ[0][4][0]=2.24433;id->ID_x2AoverQ[0][4][1]=42.5864;
  ...
  //frs->bfield[0] = 5.3234;// Brho 2019-Nov20       // FRS D1
  //frs->bfield[1] = 5.3234;// Brho 2019-Nov20      // FRS D2 field [Tesla]  
  frs->bfield[0] = 5.8086;// Brho 2019-Nov20       // FRS D1
  frs->bfield[1] = 5.8086;// Brho 2019-Nov20      // FRS D2 field [Tesla]  
  //  frs->bfield[2] = 5.1852;// Brho 2019-Nov20       // FRS D3 field [Tesla]
  //  frs->bfield[3] = 5.1853;// Brho 2019-Nov20      // FRS D4 field [Tesla]
  //frs->bfield[2] = 4.8954;// Brho 2019-Nov22       // FRS D3 field [Tesla]
  //frs->bfield[3] = 4.8954;// Brho 2019-Nov22      // FRS D4 field [Tesla] 
