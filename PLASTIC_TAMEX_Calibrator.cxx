...
void PLASTIC_TAMEX_Calibrator::load_Calibration_Files(){
    ...
    ifstream map_file("Configuration_Files/Calibration_PLASTIC_TAMEX/MAP.dat");
    ...
    for(int i = 0;i < iter;++i){
        ...
        sprintf(filename,"Configuration_Files/Calibration_PLASTIC_TAMEX/Calib_%d_%d.dat",tamex_id,ch_id);
        file.open(filename);
...
void PLASTIC_TAMEX_Calibrator::ONLINE_CALIBRATION(){
    ...
    ofstream map_file("Configuration_Files/Calibration_PLASTIC_TAMEX/MAP.dat");
    ...
    for(int i = 0;i < 100;++i){
        for(int j = 0;j < 100;++j){
            ...
            if(fired[i][j]){
                ...
                sprintf(filename,"Configuration_Files/Calibration_PLASTIC_TAMEX/Calib_%d_%d.dat",i,j);
