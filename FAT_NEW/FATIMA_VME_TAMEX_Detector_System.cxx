#include "FATIMA_TAMEX_VME_Detector_System.h"
#include <cstdlib>
...
FATIMA_TAMEX_VME_Detector_System::FATIMA_TAMEX_VME_Detector_System(){
...
void FATIMA_TAMEX_VME_Detector_System::get_Event_data(Raw_Event* RAW){
...
void FATIMA_TAMEX_VME_Detector_System::Process_MBS(int* pdata){
...
void FATIMA_TAMEX_VME_Detector_System::Process_TAMEX(){
...
void FATIMA_TAMEX_VME_Detector_System::skip_padding(){
...
void FATIMA_TAMEX_VME_Detector_System::get_trigger(){
...
void FATIMA_TAMEX_VME_Detector_System::reset_edges(){
    for(int i = 0;i < 4;++i){
        for(int j = 0;j < 100;++j){
            leading_hits[i][j] = 0;
            trailing_hits[i][j] = 0;
...
void FATIMA_TAMEX_VME_Detector_System::get_edges(){
...
bool FATIMA_TAMEX_VME_Detector_System::no_error_reached(){
...
void FATIMA_TAMEX_VME_Detector_System::check_error(){
    //next word
    //pdata++;
...
void FATIMA_TAMEX_VME_Detector_System::check_trailer(){
    //next word
    pdata++;
...
void FATIMA_TAMEX_VME_Detector_System::calibrate_ONLINE(){
...
void FATIMA_TAMEX_VME_Detector_System::calibrate_OFFLINE(){
...
int* FATIMA_TAMEX_VME_Detector_System::get_pdata(){return pdata;}

//---------------------------------------------------------------

bool FATIMA_TAMEX_VME_Detector_System::calibration_done(){return Calibration_Done;}

//---------------------------------------------------------------

void FATIMA_TAMEX_VME_Detector_System::get_Calib_type(){
    ifstream data("Configuration_Files/FATIMA_TAMEX_CALIB_FILE.txt");
    if(data.fail()){
    ...
    if(!FORCE){
        ofstream out("Configuration_Files/FATIMA_TAMEX_CALIB_FILE.txt");
