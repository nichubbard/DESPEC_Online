...
PLASTIC_VME_Event::PLASTIC_VME_Event(int* positions_tmp,int length,Raw_Event* RAW) : Events(positions_tmp,length){
    set_DATA(RAW);
}

//---------------------------------------------------------------

PLASTIC_VME_Event::~PLASTIC_VME_Event(){}

//---------------------------------------------------------------

inline void PLASTIC_VME_Event::set_DATA(Raw_Event* RAW){
...
void PLASTIC_VME_Event::Write_Event(Tree_Creator* Tree){
